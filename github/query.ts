        ...
        & { comments: (
          ...
          & { nodes?: Maybe<Array<Maybe<(
            ...
            & { star: (
              ...
              { __typename?: 'EnterpriseUserAccount' }
              & Pick<EnterpriseUserAccount, 'login' | 'url'>
            ) | (
              { __typename?: 'Mannequin' }
              & Pick<Mannequin, 'login' | 'url'>
            ) | (
              { __typename?: 'Organization' }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    issues(variables?: IssuesQueryVariables): Promise<IssuesQuery> {
      return withWrapper(() => client.request<IssuesQuery>(print(IssuesDocument), variables));
    }
  };
}
